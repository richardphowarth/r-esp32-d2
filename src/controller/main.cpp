...
void setup()
{
    ...
    memcpy(peerInfo.peer_addr, MOTOR_NODE_MAC, 6);
    esp_now_add_peer(&peerInfo);
    memcpy(peerInfo.peer_addr, DOME_NODE_MAC, 6);
    esp_now_add_peer(&peerInfo);
...
void loop()
{
    ...
    esp_now_send(MOTOR_NODE_MAC, (uint8_t *)&driveCmd, sizeof(driveCmd));
    esp_now_send(DOME_NODE_MAC, (uint8_t *)&domeCmd, sizeof(domeCmd));
    packetsSent++;
